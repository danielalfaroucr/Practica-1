--CREACIÓN DE LA BASE DE DATOS. Con la sintaxis CREATE DATABASE base, se crea la base de datos negocio.
...
--Llenado de la tabla Proveedor.
	INSERT INTO Proveedor (cedula, nombre, correo, telefono, id_distrito,TipoCedula) VALUES
		(123456789, 'Proveedor 1', 'proveedor1@email.com', 12345678, 1,'Juridica'),  
		(234567890, 'Proveedor 2', 'proveedor2@email.com', 23456789, 2,'Juridica'),  
		(345678901, 'Proveedor 3', 'proveedor3@email.com', 34567890, 3,'Juridica'),  
		(456789012, 'Proveedor 4', 'proveedor4@email.com', 45678901, 4,'Fisica'),
		(567890123, 'Proveedor 5', 'proveedor5@email.com', 56789012, 20,'Fisica'), 
		(678901234, 'Proveedor 6', 'proveedor6@email.com', 67890123, 21,'Fisica'),
		(789012345, 'Proveedor 7', 'proveedor7@email.com', 78901234, 35,'Juridica'),
		(890123456, 'Proveedor 8', 'proveedor8@email.com', 89012345, 36,'Juridica'),
		(901234567, 'Proveedor 9', 'proveedor9@email.com', 90123456, 43,'Juridica'),
		(112233445, 'Proveedor 10', 'proveedor10@email.com', 22000000, 44,'Fisica'),
		(223344556, 'Proveedor 11', 'proveedor11@email.com', 22334455, 51,'Fisica'),  
		(334455667, 'Proveedor 12', 'proveedor12@email.com', 22279540,52,'Juridica'),
		(445566778, 'Proveedor 13', 'proveedor13@email.com', 44556677, 62,'Fisica'),  
		(556677889, 'Proveedor 14', 'proveedor14@email.com', 50164181,63,'Juridica'),
		(667788990, 'Proveedor 15', 'proveedor15@email.com', 66778899, 73,'Fisica'),  
		(778899001, 'Proveedor 16', 'proveedor16@email.com', 54789635, 74,'Fisica'),
		(889900112, 'Proveedor 17', 'proveedor17@email.com', 88990011, 65,'Juridica'),
		(990011223, 'Proveedor 18', 'proveedor18@email.com', 56432158,78,'Juridica');  
